...
$(document).ready(function(e){
    $('.copyright').html('©2022 <i class="fa-fw fas fa-heartbeat card-announcement-animation cc_pointer"></i> By Blonde_Marisa');
})
...
$('.framework-info').html('后花园已开放<span id="span_dt_dt" style="color: #fff;"></span>');
